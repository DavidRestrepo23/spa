 ...
 * https://summernote.org card padding 
 *
...
$(".note-view").append('<button type="button" onclick="publicity()" class="note-btn btn btn-light btn-sm" data-toggle="tooltip" data-placement="bottom" title="Agregar publicidad" tabindex="-1"><i class="fas fa-bullhorn"></i></button>');
});
