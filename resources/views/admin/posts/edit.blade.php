  ...
  <div class="card" style="margin-bottom: 20px;">
      ...
      <div class="card-body" style="margin-bottom: 30px;">
          ...
          <div class="row">
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                <div class="form-group" style="margin-top: 20px;">
                  ...
                  <div>
                      {{ Form::textarea('excerpt', null, ['class'=>'form-control','rows'=> '6', 'id' => 'excerpt', 'style' => 'border:1px solid #c1c1c1','maxlength' => '128'])}}                    
                  </div>
              ...
              <br>
               <div class="form-group">
                 ...
                 <div class="" style="margin-top: 20px;">
                   <img src="{{$post->file}}" class="img-thumbnail" width="250" height="250" alt="">
                 </div>
               </div>
              </div>
                ...
                <div class="row" style="margin-top:20px; ">
                  <div class="col-xs-12 col-sm-12">
                      <div class="form-group">
                          ...
                          {{Form::textarea('description', $post->meta->description, ['class' => 'form-control', 'style' => 'border-radius:0;font-size:10pt;border:1px solid #C5C5C5', 'maxlength' => '128'])}}
                  ...
                  <div class="col-xs-12 col-sm-12">
                      <div class="form-group">
                          ...
                          {{Form::textarea('keywords', $post->meta->keywords, ['class' => 'form-control', 'style' => 'border-radius:0;font-size:10pt;border:1px solid #C5C5C5', 'placeholder' => 'Example, example2, example3,...'])}}
            ...
            {{Form::select('tags[]', $tags, null, ['class' => 'selectpicker', 'multiple' => true] )}}
            <hr>
            ...
            <div class="row" style="margin-top: 15%;">
              <div class="col-xs-12 col-sm-12 text-center">
                <button type="submit" class="btn btn-info"><i class="fas fa-edit"></i> Actualizar entrada</button>
              </div>
            </div>
            </div>
          </div>
